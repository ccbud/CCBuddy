...
window.ccbudIcons = {
  ...
  newSession: '<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 3.5h10a1 1 0 011 1v5.5a1 1 0 01-1 1H7l-2.5 2v-2H3a1 1 0 01-1-1V4.5a1 1 0 011-1z" stroke="currentColor" stroke-width="1.35" stroke-linejoin="round"/><path d="M8 5.2v3.1M6.45 6.75h3.1" stroke="currentColor" stroke-width="1.35" stroke-linecap="round"/></svg>',
  send: '<svg width="15" height="15" viewBox="0 0 16 16" fill="none"><path d="M14 2L7.5 8.5M14 2L9.8 14l-2.3-5.5L2 6.2 14 2z" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round" stroke-linecap="round"/></svg>',
