...
/* oxlint-disable eslint(max-lines) -- CCbuddy Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
...
import { completeNewModelSelection } from "@ccbuddy/provider";
import type { OffPeakClientConfig } from "#src/coding-plan-subscription/codingPlanSubscription.js";
import {
  CCBUDDY_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  resolveWorkspaceKey,
  type TraceId,
  CCBUDDY_AGENT_PROVIDER,
  CCBUDDY_AGENT_PROVIDER_NOT_READY_CODE,
  CCBUDDY_AGENT_PROVIDER_NOT_READY_REASON,
  CCBUDDY_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  CCBUDDY_PROTOCOL_NAME,
  CCBUDDY_PROTOCOL_VERSION,
  ccbuddyMcpListResultSchema,
  ccbuddyPermissionRequestParamsSchema,
  ccbuddyBrowserListParamsSchema,
  ccbuddyBrowserExecuteParamsSchema,
  ccbuddyPluginsConfigureResultSchema,
  ccbuddyPluginsInstallResultSchema,
  ccbuddyPluginsListResultSchema,
  ccbuddyPluginsMarketplaceMutationResultSchema,
  ccbuddyPluginsOverviewResultSchema,
  ...
  ccbuddyWorkflowsMoveResultSchema,
  ccbuddyWorkflowsRunsResultSchema,
  ccbuddyWorkflowsUpdateMetaResultSchema,
  ccbuddyPluginsResolveSuggestedReferenceResultSchema,
  ccbuddyPluginOperationProgressNotificationSchema,
  ccbuddyPluginsRestoreBuiltinResultSchema,
  ccbuddyPluginsSetEnabledResultSchema,
  ccbuddyPluginsCancelOperationResultSchema,
  ccbuddyPluginsUninstallResultSchema,
  ccbuddyPluginsValidateResultSchema,
  ccbuddyPluginsDescribeResultSchema,
  ccbuddyAutomationCheckTaskBindingParamsSchema,
  ccbuddyAutomationCreateParamsSchema,
  ccbuddyAutomationDeleteParamsSchema,
  ccbuddyAutomationListParamsSchema,
  ccbuddyAutomationUpdateParamsSchema,
  ccbuddyOffPeakCreateParamsSchema,
  ccbuddyOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  ccbuddyComputerUseOperationEventSchema,
  ccbuddyProviderRuntimeHeadersCancelledSchema,
  ccbuddyProviderRuntimeHeadersRequestParamsSchema,
  ccbuddyProviderTestModelConnectivityResultSchema,
  ccbuddyOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  ccbuddyProtocolEmptyResultSchema,
  ccbuddyProtocolMethods,
  ccbuddyProtocolNotifications,
  ccbuddyMcpTelemetryEventSchema,
  ccbuddyMcpResourceSamplesSchema,
  ccbuddyToolExecResourceSchema,
  ccbuddyProcessResourceSampleSchema,
  ccbuddySessionCloseResultSchema,
  ccbuddySessionCompactResultSchema,
  ccbuddySessionEventsResultSchema,
  ccbuddySessionGoalResultSchema,
  ccbuddySessionListResultSchema,
  ccbuddySessionSubagentsResultSchema,
  ccbuddySessionMessagesResultSchema,
  ccbuddySessionEventSchema,
  ccbuddySessionSendResultSchema,
  ccbuddySessionRequestRuntimePreferencesParamsSchema,
  ccbuddySessionRuntimePreferencesResultSchema,
  ccbuddySessionStateSnapshotSchema,
  ccbuddySessionSubscribeResultSchema,
  ccbuddyStateUpdatedNotificationSchema,
  ccbuddyUserInputRequestParamsSchema,
  ccbuddyWorkspacePresentationSchema,
  ccbuddyWorkspaceCancelGenerateTextResultSchema,
  ccbuddyWorkspaceGenerateTextResultSchema,
  ccbuddyWorkspaceHookTrustGrantResultSchema,
  ccbuddyWorkspaceUpdateInteractionPreferencesResultSchema,
  ccbuddyWorkspaceUpdateModelIoPreferencesResultSchema,
  ccbuddyProviderUpdateAccountConfigResultSchema,
  type CCbuddySessionStateSnapshot,
  type CCbuddyAutomation,
  type CCbuddyAutomationRun,
  ccbuddyWorkspaceUpdateOffPeakToolPolicyResultSchema,
  ccbuddyWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  ...
  type CCbuddyToolExecResource,
  type CCbuddyPluginOperationProgressNotification,
  type CCbuddyTaskMode,
} from "@ccbuddy/shared";
...
} from "#src/ccbuddy-agent/automationToolPolicy.js";
import { CCBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./ccbuddyAgent.js";
import type {
  CCbuddyProtocolRequestId,
  ModelSelection,
  CCbuddyProviderRuntimeHeadersRequestParams,
  CCbuddySessionEvent,
  CCbuddySessionRuntimePreferencesScope,
  CCbuddySavedWorkflowScope,
...
import type {
  ...
  CCbuddyAgentBackgroundBashOutputParams,
  CCbuddyAgentAppRuntimePreferences,
  CCbuddyAgentRuntimeLifecycleEvent,
  CCbuddyAgentAddPluginMarketplaceParams,
  CCbuddyAgentAppUsageParams,
  CCbuddyAgentCancelPluginOperationParams,
  CCbuddyAgentCompactParams,
  CCbuddyAgentConfigurePluginParams,
  CCbuddyAgentResetPluginConfigParams,
  CCbuddyAgentCreateSessionParams,
  CCbuddyAgentInstallPluginParams,
  CCbuddyAgentGenerateWorkspaceTextParams,
  CCbuddyAgentTestModelConnectivityParams,
  CCbuddyAgentGoalParams,
  CCbuddyAgentGrantWorkspaceHookTrustParams,
  CCbuddyAgentInitializeResult,
  CCbuddyAgentListSessionsParams,
  CCbuddyAgentListSessionSubagentsParams,
  CCbuddyAgentReadWorkspacePresentationParams,
  CCbuddyAgentReadSessionEventsParams,
  CCbuddyAgentReadSessionMessagesParams,
  CCbuddyAgentReadSessionParams,
  CCbuddyAgentRemovePluginMarketplaceParams,
  CCbuddyAgentRespondSessionRuntimePreferencesParams,
  CCbuddyAgentResumeSessionParams,
  CCbuddyAgentSendPromptParams,
  CCbuddyAgentServiceEvent,
  CCbuddyAgentSessionSubscribeParams,
  CCbuddyAgentSessionTarget,
  CCbuddyAgentSessionRuntimePreferencesRequest,
  CCbuddyAgentTaskTokenUsageParams,
  CCbuddyAgentSetModeParams,
  CCbuddyAgentSetModelParams,
  ...
  CCbuddyAgentSavedWorkflowTarget,
  ...
  CCbuddyAgentCuaPermissionObservation,
  ...
  CCbuddyAgentAttachmentBeginParams,
  CCbuddyAgentAttachmentChunkParams,
  CCbuddyAgentAttachmentReadParams,
  CCbuddyAgentConversationAttachmentReadParams,
  CCbuddyAgentConversationAttachmentStatParams,
  CCbuddyAgentAttachmentPreviewSourceParams,
  CCbuddyAgentAttachmentTerminalParams,
  CCbuddyAgentConversationCommandParams,
  CCbuddyAgentCommandsQueryParams,
  CCbuddyAgentConversationFileChangesParams,
  CCbuddyAgentConversationFileRewindPreviewParams,
  CCbuddyAgentConversationRowsRangeParams,
  CCbuddyAgentConversationPlansParams,
  CCbuddyAgentConversationWorkflowRunEventsParams,
  CCbuddyAgentConversationWorkflowRunArtifactDataParams,
  CCbuddyAgentConversationWorkflowRunArtifactReadParams,
  CCbuddyAgentConversationWorkflowRunArtifactsParams,
  CCbuddyAgentConversationWorkflowRunNodeResultParams,
  CCbuddyAgentConversationWorkflowRunWorkspaceParams,
  CCbuddyAgentConversationWorkflowRunsParams,
  CCbuddyAgentConversationResyncParams,
  CCbuddyAgentConversationSubscribeParams,
  CCbuddyAgentConversationUnsubscribeParams,
  CCbuddyAgentConnectionFlowParams,
  CCbuddyAgentSessionsIndexSubscribeParams,
  CCbuddyAgentWorkspaceConfigSubscribeParams,
} from "./ccbuddyAgent.js";
import {
  ...
  utf8JsonByteLength,
  CCBUDDY_ATTACHMENT_FAULT_CODES,
  CCbuddyAttachmentFaultError,
  type CommandAck,
...
import {
  readTrustedCCbuddyAgentV4Connection,
  readTrustedCCbuddyAgentV4UnsubscribeRoute,
  type CCbuddyAgentV4ConnectionContext,
} from "./ccbuddyAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/ccbuddy-agent/ccbuddySessionEventCoalescer.js";
...
import { CCbuddyAgentMcpStatusModeUnsupportedError } from "#src/ccbuddy-agent/ccbuddyAgentErrors.js";
import { CCbuddyAgentProcessManager } from "./ccbuddyAgentProcessManager.js";
import type { CCbuddyAgentProcessManagerOptions } from "./ccbuddyAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  CCbuddyProtocolRequestTimeoutError,
  type CCbuddyProtocolClient,
} from "./ccbuddyProtocolClient.js";
import { getCCbuddyDataRootDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./ccbuddyAgentBrowserAmbientContext.js";
import {
...
interface PendingPermissionRequest {
  client: CCbuddyProtocolClient;
  protocolRequestId: CCbuddyProtocolRequestId;
}

interface PendingProviderRuntimeHeadersRequest extends PendingPermissionRequest {
  request: CCbuddyProviderRuntimeHeadersRequestParams;
  responding?: boolean;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: CCbuddyAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "CCbuddy Agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: CCbuddyAgentWorkspaceTarget): CCbuddyWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: CCbuddyAgentSavedWorkflowTarget,
): params is CCbuddyAgentWorkspaceTarget & { scope?: CCbuddySavedWorkflowScope } {
  return typeof (params as Partial<CCbuddyAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: CCbuddyAgentSavedWorkflowTarget): {
  scope?: CCbuddySavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getCCbuddyDataRootDir(), PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the CCbuddy Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.ccbuddy/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when ccbuddy-cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__ccbuddy-cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof CCbuddyProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return (
    error instanceof Error && error.message === `CCbuddy Protocol request timed out: ${method}`
  );
}
...
function buildSessionCreateParams(
  params: CCbuddyAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: CCbuddyAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: CCbuddyAgentSendPromptParams,
...
function buildSessionCompactParams(params: CCbuddyAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function formatModelSelectionForLog(ref: ModelSelection | undefined): string | null {
  ...
  return reasoningLevel ? `${base}${CCBUDDY_MODEL_REASONING_SEPARATOR}${reasoningLevel}` : base;
}

function sessionEventKey(params: CCbuddyAgentSessionTarget): string {
...
function permissionRequestKey(params: CCbuddyAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: CCbuddyAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: CCbuddyAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface CCbuddyAgentProviderReadinessSnapshot {
...
): CCbuddyAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: CCbuddyAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: CCbuddyAgentWorkspaceTarget): Error & {
  code: typeof CCBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("CCbuddy Agent runtime is not running.") as Error & {
    code: typeof CCBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = CCBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateCCbuddyAgentServiceOptions extends Omit<
  CCbuddyAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  ...
  resolveSessionRuntimePreferences?: (
    scope: CCbuddySessionRuntimePreferencesScope,
  ) => Promise<CCbuddySessionRuntimePreferencesResult>;
  /** manual run 落库后由当前 host 直接派发；返回时 prompt 必须已被 session 接受。 */
  onAutomationManualRunRequested?: (params: {
    automation: CCbuddyAutomation;
    run: CCbuddyAutomationRun;
  }) => Promise<void>;
  /**
...
function toProtocolAutomation(automation: CCbuddyAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<CCbuddyProtocolClient, "respondError">,
  request: { id: CCbuddyProtocolRequestId; method: string },
  workspace: CCbuddyAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createCCbuddyAgentService(
  options?: CreateCCbuddyAgentServiceOptions,
): ICCbuddyAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new CCbuddyAgentProcessManager(options);
  ...
  const pluginProcessManager = new CCbuddyAgentProcessManager({
  ...
  const mcpStatusProcessManager = new CCbuddyAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<CCbuddyAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<CCbuddyAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<CCbuddyToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<CCbuddyMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<CCbuddyMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<CCbuddyPluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<CCbuddyAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<CCbuddyProtocolClient>();
  const clientDisposables = new WeakMap<CCbuddyProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: CCbuddyAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<CCbuddyProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<CCbuddyProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: CCbuddyProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      logger.info(undefined, "CCbuddy provider runtime headers 已应用", {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "CCbuddy provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "ccbuddy_agent.runtime_preferences.host_response_timeout",
      module: "services.ccbuddy_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: CCBUDDY_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          ccbuddyProtocolMethods.providerUpdateAccountConfig,
          {
            revision: snapshot.revision,
            basedOnCCbuddyBuiltinRevision: snapshot.basedOnCCbuddyBuiltinRevision,
        ...
        logger.info(undefined, "account provider config 已交付到 CCbuddy Agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: CCbuddyProtocolClient;
    preferences: CCbuddyAgentAppRuntimePreferences;
    workspace: CCbuddyAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          ccbuddyProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            ccbuddyProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: CCbuddyAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 CCbuddy Agent", {
  ...
  function getSessionEmitter(params: CCbuddyAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<CCbuddyAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<CCbuddyPluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: CCbuddyAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: CCbuddyAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: CCbuddyAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: CCbuddyAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  ): CCbuddyAgentV4ConnectionContext {
    return (
      readTrustedCCbuddyAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: CCbuddyAgentConversationUnsubscribeParams | CCbuddyAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedCCbuddyAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: CCbuddyAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: CCbuddyAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function handleStateUpdated(
    workspace: CCbuddyAgentWorkspaceTarget,
    notification: CCbuddyStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === ccbuddyProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = ccbuddyProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === ccbuddyProtocolNotifications.processResourceSample) {
          const parsed = ccbuddyProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 CCbuddy CLI 资源样本", {
        ...
        if (message.method === ccbuddyProtocolNotifications.toolExecResource) {
          const parsed = ccbuddyToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === ccbuddyProtocolNotifications.mcpResourceSamples) {
          const parsed = ccbuddyMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === ccbuddyProtocolNotifications.mcpTelemetry) {
          const parsed = ccbuddyMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 CCbuddy CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === ccbuddyProtocolNotifications.pluginOperationProgress) {
          const parsed = ccbuddyPluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 CCbuddy Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === ccbuddyProtocolMethods.computerUseOperationEvent) {
          const parsed = ccbuddyComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 CCbuddy Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = ccbuddySessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 CCbuddy Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = ccbuddyStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === ccbuddyProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = ccbuddySessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: CCbuddySessionRuntimePreferencesResult;
              try {
                preferences = ccbuddySessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: CCbuddyAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "ccbuddy_agent.runtime_preferences.host_request_dispatched",
            module: "services.ccbuddy_agent",
            requestId,
        ...
        if (request.method === ccbuddyProtocolMethods.interactionRequestPermission) {
          const parsed = ccbuddyPermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === ccbuddyProtocolMethods.interactionRequestUserInput) {
          const parsed = ccbuddyUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = ccbuddyProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 CCbuddy provider runtime headers 请求", {
        ...
        if (request.method === ccbuddyProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = ccbuddyOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.interactionBrowserList) {
          const parsed = ccbuddyBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.interactionBrowserExecute) {
          const parsed = ccbuddyBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.automationCreate) {
          const parsed = ccbuddyAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.offPeakCreate) {
          const parsed = ccbuddyOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.offPeakList) {
          const parsed = ccbuddyOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.automationList) {
          const parsed = ccbuddyAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.automationCheckTaskBinding) {
          const parsed = ccbuddyAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.automationUpdate) {
          const parsed = ccbuddyAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === ccbuddyProtocolMethods.automationDelete) {
          const parsed = ccbuddyAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported CCbuddy Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: CCbuddyAgentSessionTarget,
  ...
  function getSessionTraceId(target: CCbuddyAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof CCBUDDY_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof CCBUDDY_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    const error = new Error(
      "当前没有可用的模型服务，请先配置你自己的模型服务和 API Key。",
    ) as Error & {
      code: typeof CCBUDDY_AGENT_PROVIDER_NOT_READY_CODE;
      data: {
        providerCount: number;
    ...
    error.code = CCBUDDY_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: CCBUDDY_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof CCBUDDY_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === CCBUDDY_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    CCbuddyAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 CCbuddy Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: CCbuddyAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          ccbuddyProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          ccbuddyProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          ccbuddyWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 CCbuddy Agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: CCbuddyAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，CCbuddy Agent 保持只读"
            : "provider/model 尚未就绪，CCbuddy Agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 CCbuddy Agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<CCbuddyProtocolClient> {
  ...
  // 全局工作流目录在 `~/.ccbuddy/workflows/`，因此管理面可读取同一份数据。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: CCbuddyAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveSavedWorkflowCarrier(
    params: CCbuddyAgentSavedWorkflowTarget,
  ): Promise<{ client: CCbuddyProtocolClient; workspace: CCbuddyWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<CCbuddyProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: CCbuddyAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: CCbuddyAgentWorkspaceTarget): Promise<CCbuddyAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 CCbuddy Agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "CCbuddy Agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: CCBUDDY_PROTOCOL_NAME,
          protocolVersion: CCBUDDY_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "CCbuddy Agent 等待 provider/model 就绪" : "CCbuddy Agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: CCBUDDY_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: CCbuddyAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: CCbuddyAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: CCbuddyAgentWorkspaceTarget) {
    ...
    async createSession(params: CCbuddyAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 CCbuddy Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          ccbuddyProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "CCbuddy Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "CCbuddy Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "CCbuddy Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "CCbuddy Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          ccbuddyProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "CCbuddy Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: CCbuddyAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 CCbuddy Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          ccbuddyProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "CCbuddy Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "CCbuddy Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "CCbuddy Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "CCbuddy Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: CCbuddyAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        ccbuddyProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: CCbuddyAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        ccbuddyProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: CCbuddyAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: CCbuddyAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: CCbuddyAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        ccbuddyProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: CCbuddyAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        ccbuddyProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        ccbuddyProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: CCbuddyAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        ccbuddyProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: CCbuddyAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 CCbuddy Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: CCbuddyWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              ccbuddyProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              ccbuddyWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("CCbuddy Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "CCbuddy Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "CCbuddy Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: CCbuddyAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: CCbuddyAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new CCbuddyAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, ccbuddyProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: CCbuddyAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          ccbuddyProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, ccbuddyProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: CCbuddyAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: CCbuddyAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        ccbuddyProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: CCbuddyAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        ccbuddyProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        ccbuddyWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: CCbuddyAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        ccbuddyProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        ccbuddyWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: CCbuddyAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        ccbuddyProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        ccbuddyWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: CCbuddyAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        ccbuddyProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        ccbuddyWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: CCbuddyAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        ccbuddyProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: CCbuddyAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        ccbuddyProtocolMethods.workflowsMove,
    ...
    async resolveSuggestedPluginReference(
      ...
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsResolveSuggestedReference,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: CCbuddyProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              ccbuddyProtocolMethods.processChildProcesses,
              {},
              ccbuddyProcessChildProcessesResultSchema,
          ...
          return {
            pid: runtime.pid,
            provider: CCBUDDY_AGENT_PROVIDER,
    ...
    async getPluginsOverview(params: CCbuddyAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: CCbuddyAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: CCbuddyAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: CCbuddyAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: CCbuddyAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: CCbuddyAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        ccbuddyPluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: CCbuddyAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: CCbuddyAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: CCbuddyAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: CCbuddyAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: CCbuddyAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: CCbuddyAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: CCbuddyAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: CCbuddyAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        ccbuddyProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: CCbuddyAgentWorkspaceTarget) {
    ...
    async createAutomation(params: CCbuddyAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as CCbuddyTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: CCbuddyAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as CCbuddyTaskMode | undefined),
    ...
    async deleteAutomation(params: CCbuddyAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: CCbuddyAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: CCbuddyAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: CCbuddyAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: CCbuddyAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: CCbuddyAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: CCbuddyAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 CCbuddy Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      const cancel = () => {
        ...
        void client
          .request(
            ccbuddyProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            ccbuddyWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          ccbuddyProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: CCbuddyAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      return client.request(
        ccbuddyProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: CCbuddyAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: CCbuddyAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "CCbuddy Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          ccbuddyProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          ccbuddySessionSendResultSchema,
        );
        logger.info(logTraceId, "CCbuddy Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "CCbuddy Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "CCbuddy Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: CCbuddyAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "CCbuddy Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          ccbuddyProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "CCbuddy Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "CCbuddy Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: CCbuddyAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 CCbuddy Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          ccbuddyProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "CCbuddy Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "CCbuddy Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: CCbuddyAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        ccbuddyProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: CCbuddyAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 CCbuddy Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          ccbuddyProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "CCbuddy Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "CCbuddy Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: CCbuddyAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        ccbuddyProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: CCbuddyAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        ccbuddyProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      ...
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "ccbuddy_agent.runtime_preferences.response_without_pending",
          module: "services.ccbuddy_agent",
          requestId: params.requestId,
        });
        throw new Error(
          `CCbuddy session runtime preferences request not found: ${params.requestId}`,
        );
      }
      const responseContext = {
        event: "ccbuddy_agent.runtime_preferences.host_response_received",
        module: "services.ccbuddy_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: CCbuddyAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: CCbuddyAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: CCbuddyAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              ccbuddyProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("ccbuddy-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: CCbuddyAgentConnectionFlowParams) {
      const trusted = readTrustedCCbuddyAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: CCbuddyAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。CCbuddy Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: CCbuddyAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: CCbuddyAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: CCbuddyAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedCCbuddyAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // CCbuddy Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: CCbuddyAgentCommandsQueryParams) {
      if (!readTrustedCCbuddyAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: CCbuddyAgentAttachmentBeginParams) {
      const trusted = readTrustedCCbuddyAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: CCbuddyAgentAttachmentChunkParams) {
      const trusted = readTrustedCCbuddyAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: CCbuddyAgentAttachmentTerminalParams) {
      const trusted = readTrustedCCbuddyAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: CCbuddyAgentAttachmentTerminalParams) {
      const trusted = readTrustedCCbuddyAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: CCbuddyAgentAttachmentReadParams) {
      if (!readTrustedCCbuddyAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: CCbuddyAgentConversationAttachmentReadParams) {
      if (!readTrustedCCbuddyAgentV4Connection(params)) {
        throw new CCbuddyAttachmentFaultError(
          CCBUDDY_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: CCbuddyAgentConversationAttachmentStatParams) {
      if (!readTrustedCCbuddyAgentV4Connection(params)) {
        throw new CCbuddyAttachmentFaultError(
          CCBUDDY_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: CCbuddyAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedCCbuddyAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: CCbuddyAgentConversationRowsRangeParams) {
      const trusted = readTrustedCCbuddyAgentV4Connection(params);
    ...
    async conversationPlansV4(params: CCbuddyAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: CCbuddyAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: CCbuddyAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: CCbuddyAgentBackgroundBashOutputParams) {
      if (!readTrustedCCbuddyAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: CCbuddyAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: CCbuddyAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: CCbuddyAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: CCbuddyAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: CCbuddyAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: CCbuddyAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: CCbuddyAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: CCbuddyAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: CCbuddyAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: CCbuddyAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: CCbuddyAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: CCbuddyAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: CCbuddyAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: CCbuddyAgentRuntimeLifecycleEvent) => void) {
