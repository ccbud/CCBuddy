import { ccbuddyProtocolMethods, ccbuddyRuntimeCapabilitiesSchema } from "@ccbuddy/shared";
import type { CCbuddyProtocolClient } from "./ccbuddyProtocolClient.js";
...
export function ensureIndependentPlanSupport(
  ...
  const check = client
    .request(ccbuddyProtocolMethods.runtimeCapabilities, {}, ccbuddyRuntimeCapabilitiesSchema)
    .then((result) => {
