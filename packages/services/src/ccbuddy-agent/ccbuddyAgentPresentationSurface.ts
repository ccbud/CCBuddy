import type { ServiceAuthorityMode } from "@ccbuddy/shared";

export type CCbuddyAgentPresentationSurface = "desktop";

interface CCbuddyAgentPresentationHostFacts {
...
export function resolveCCbuddyAgentPresentationSurface(
  facts: CCbuddyAgentPresentationHostFacts,
): CCbuddyAgentPresentationSurface | undefined {
