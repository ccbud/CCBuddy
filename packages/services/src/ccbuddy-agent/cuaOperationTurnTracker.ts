import { resolveWorkspaceKey, type CCbuddyComputerUseOperationEvent } from "@ccbuddy/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: CCbuddyComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: CCbuddyComputerUseOperationEvent,
  ): void {
