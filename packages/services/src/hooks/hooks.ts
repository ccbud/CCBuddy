import type { Hook, CCbuddyWorkspaceHookTrustGrantResult } from "@ccbuddy/shared";
import type { WorkspaceHookBundleSnapshotData } from "@ccbuddy/shared/workspace-hook-discovery";
