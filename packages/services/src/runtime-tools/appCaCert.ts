...
const APP_CA_CERT_FILE = "ccbuddy-network-ca.pem";
const APP_CA_KEY_FILE = "ccbuddy-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "CCbuddy Network CA" },
    { name: "organizationName", value: "CCbuddy" },
  ];
