...
import { HELPER_ADDON_ENV, WINDOWS_DEV_CONTROL_PROTOCOL } from "@ccbuddy/ccbuddy-cua/broker/server";
...
/**
 * Parse a `ccbuddy-cua-windows-dev/v1` control message from the helper child.
 *
