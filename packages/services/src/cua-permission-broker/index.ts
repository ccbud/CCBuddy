...
// @ccbuddy/ccbuddy-cua as part of the single-package merge. This file preserves
...
//
// Why two layers:
//   - `@ccbuddy/ccbuddy-cua/broker/server` (51 server files) — broker server +
...
//   - `@ccbuddy/ccbuddy-cua/broker` (protocol) — brokerProtocol / helperErrors /
...
export * from "@ccbuddy/ccbuddy-cua/broker/server";
