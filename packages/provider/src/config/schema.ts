import { z } from "zod";
import { modelConfigDataSchema } from "@ccbuddy/shared/model-config";
...
export function parseCCbuddyBuiltinProviderConfigMap(input: unknown): ProviderConfigMap {
...
export function parseCCbuddyBuiltinProviderConfigRules(input: unknown): {
...
export function parseCCbuddyBuiltinModelConfigRules(input: unknown): ModelConfigRules {
