...
export class ProviderSettingsFacade {
  ...
  getView(): ProviderSettingsView {
    ...
    return createProviderSettingsView({
      ...
      ccbuddyBuiltinProviders: snapshot.config.ccbuddyBuiltinProviders,
      ccbuddyBuiltinProviderTemplates: snapshot.config.ccbuddyBuiltinProviderTemplates,
  ...
  resolveModelConfig(input: ResolveModelConfigInput): ModelConfigResolution {
    ...
    if (!("personalConfig" in input)) {
      const modelRules = ModelConfigRules.composeEffective(
        snapshot.config.ccbuddyBuiltinModelRules,
    ...
    const inheritedConfig = snapshot.config.ccbuddyBuiltinModelRules.resolve({
      providerId: input.providerId,
      templateId: provider.templateId,
      modelId: input.modelId,
      apiType: provider.config.api?.type,
...
function createProviderSettingsView(input: {
  revision: number;
  ccbuddyBuiltinProviders: ProviderRegistryServiceSnapshot["config"]["ccbuddyBuiltinProviders"];
  ccbuddyBuiltinProviderTemplates: ProviderRegistryServiceSnapshot["config"]["ccbuddyBuiltinProviderTemplates"];
  ...
  return Object.freeze({
    ...
    providerTemplates: Object.freeze(
      (input.ccbuddyBuiltinProviderTemplates ?? ProviderTemplateMap.empty())
        .entries()
