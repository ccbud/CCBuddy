...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnCCbuddyBuiltinRevision !== config.ccbuddyBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          ccbuddyBuiltinProviders: config.ccbuddyBuiltinProviders,
          ccbuddyBuiltinProviderTemplates: config.ccbuddyBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          ccbuddyBuiltinModelRules: config.ccbuddyBuiltinModelRules,
