// Agent bundle 的暂存动作：把 apps/ccbuddy-cli/packages/cli/dist/ccbuddy.cjs 放进
...
// desktopRuntimeEnv.ts 的 resolveBundledCCbuddyAgentBinaryPath() 解析，候选**只有**
...
export const AGENT_BUNDLE_SOURCE_RELATIVE = "apps/ccbuddy-cli/packages/cli/dist/ccbuddy.cjs";
...
export function resolveAgentBundlePaths({ repoRoot, platformKey }) {
  ...
  return {
    ...
    glmDir,
    stagedBundlePath: resolve(glmDir, "ccbuddy.cjs"),
 ...
 * （ccbuddy-agent / ccbuddy-acp 等）和旧 meta 会被一并打进安装包（CI 干净检出不会有，本地会）。
 */
