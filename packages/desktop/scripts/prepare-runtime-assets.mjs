...
const shouldSkipRemoteAssets = process.env.CCBUDDY_SKIP_REMOTE_ASSETS === "1";
...
if (!shouldSkipRemoteAssets) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (CCBUDDY_SKIP_REMOTE_ASSETS=1)");
}
