...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "ccbuddy";
export const DEV_ELECTRON_APP_NAME = "CCbuddy Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "app.ccbuddy.desktop.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 ccbuddy URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 ccbuddy 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".ccbuddy-dev-electron-source.json");
