...
export function reportMcpTelemetryToArms(
  event: CCbuddyMcpTelemetryEvent,
...
function mapMcpTelemetryEvent(event: Exclude<CCbuddyMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<CCbuddyMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
