...
import type { ApplicationIconInfo } from "@ccbuddy/shared";
...
public static class CCbuddyAumidIcon {
...
'@;
$ccbuddyIconBytes=[CCbuddyAumidIcon]::Read($ccbuddyArg0);
[Console]::Out.Write([Convert]::ToBase64String($ccbuddyIconBytes));
`;
