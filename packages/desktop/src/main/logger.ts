...
import { formatTimestamp } from "@ccbuddy/shared";
import { cleanupExpiredLogFiles, LOG_RETENTION_DAYS } from "./logRetention.js";
import { getAppConfigDir, maybeThrowInjectedFsFault } from "@ccbuddy/services/node";
...
/**
 * main 进程日志，默认写入 ~/.ccbuddy/v2/logs/YYYY-MM-DD.log；E2E 测试使用 worker 专属目录。
