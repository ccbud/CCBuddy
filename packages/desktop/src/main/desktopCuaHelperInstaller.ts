...
import { HELPER_APP_NAME } from "@ccbuddy/ccbuddy-cua/broker/helperConstants";
import {
...
export { normalizeCuaHelperArch, normalizeCuaHelperArchs } from "@ccbuddy/services/node";
...
export function createDesktopCuaHelperInstaller(
  ...
  if (bundledAppPath) {
    delete env.CCBUDDY_CUA_HELPER_ALLOW_UNSIGNED_LOCAL;
  }
