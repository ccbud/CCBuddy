...
import type { BrowserPlaywrightAction, BrowserPlaywrightModifier } from "@ccbuddy/shared";
...
const PLAYWRIGHT_WORLD_NAME = "ccbuddy-playwright-locator";
const PLAYWRIGHT_GLOBAL = "__ccbuddyPlaywrightInjected";
