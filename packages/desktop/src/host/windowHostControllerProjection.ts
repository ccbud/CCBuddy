...
import type { CCbuddyArchivedTaskDeletionResult } from "@ccbuddy/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: CCbuddyTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | CCbuddyArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: CCbuddyTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
