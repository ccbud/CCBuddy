import { Event as RpcEvent } from "@ccbuddy/rpc";
import type { IConversationShareService, ICCbuddyAgentService } from "@ccbuddy/services";
import { conversationShareConnectionScopeFactory } from "@ccbuddy/services/node";
