import {
  ...
  resolveCCbuddyAgentSpawnCwd,
} from "@ccbuddy/services/storage-startup";
import type { DatabaseStartupState } from "@ccbuddy/shared";
    ...
    prepare: async (report) => {
      ...
      try {
        ...
        for (const candidate of candidates) {
          ...
          const { cwd } = await resolveCCbuddyAgentSpawnCwd({
