...
import type { ResourceUsageSnapshot, StorageManagementBridge } from "@ccbuddy/shared";
...
function applyResourceManagerTheme(): void {
  const savedTheme = (localStorage.getItem("ccbuddy-theme") as Theme | null) ?? "zai-dark";
