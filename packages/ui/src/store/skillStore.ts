...
interface SkillStoreState {
  ...
  initialize: (
    ...
    providerOrSkillsService: CCbuddyProvider | ISkillsService,
  ...
  setEnabled: (
    skillId: string,
    providerOrEnabled: CCbuddyProvider | boolean,
...
export const useSkillStore = create<SkillStoreState>((set, get) => ({
  ...
  async initialize(
    ...
    const provider = normalizeAgentProviderToCCbuddyAgent(
      hasProvider ? providerOrSkillsService : CCBUDDY_AGENT_PROVIDER,
    );
