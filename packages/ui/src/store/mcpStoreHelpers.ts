...
const MCP_CONFIG_KEY = "ccbuddy-mcp-config";
export const MCP_DELETED_PRELOAD_KEY = "ccbuddy-mcp-deleted-preload";

export const DEFAULT_MCP_CONFIG: McpConfig = {
  mcp: { mcpServers: {} },
  ccbuddyagentmcp: { mcpServers: {}, projects: {} },
};
...
export function makeServerId(
  ...
  const sourceKey =
    source === "ccbuddyagentmcp" && directorySource && directorySource !== "ccbuddy"
...
export function buildServerList(
  ...
  existingServers: CCbuddyMcpServer[],
): CCbuddyMcpServer[] {
  ...
  function makeServer(
    ...
    source: McpSource,
    scope: CCbuddyMcpServer["scope"],
    enabledBySource?: boolean,
    projectPath?: string,
    file?: CCbuddyMcpServer["file"],
    location?: CCbuddyMcpServer["location"],
  ): CCbuddyMcpServer {
  ...
  const servers: CCbuddyMcpServer[] = [];
...
export function getServerPriority(server: CCbuddyMcpServer): number {
