...
import type { CCbuddyModelTrajectoryRecord } from "@ccbuddy/services";
import {
...
export function resolveTrajectoryTimelineItems(records: CCbuddyModelTrajectoryRecord[]) {
...
export function resolveTrajectoryInputMessages({
  ...
  inputMessages: CCbuddyModelTrajectoryRecord["request"]["messages"];
...
function shouldUseConversationDelta(record: CCbuddyModelTrajectoryRecord): boolean {
  const kind = record.callSource?.kind;
  return kind === undefined || kind === "main" || kind === "subagent";
}

function computeDeltaMessages(
  messages: CCbuddyModelTrajectoryRecord["request"]["messages"],
  previousMessageCount: number,
  index: number,
): CCbuddyModelTrajectoryRecord["request"]["messages"] {
