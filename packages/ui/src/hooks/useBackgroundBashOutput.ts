...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@ccbuddy/shared";
import { useCCbuddyAgentService } from "@/hooks/useCCbuddyAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useCCbuddyAgentService(workspacePath, remoteSessionId, workspaceIdentity);
