/**
 * CCbuddy Agent ConfigOptions 便捷 hooks
 *
...
import type { ConfigOptionsStatus } from "@/store/ccbuddySessionStoreTypes.js";
...
export function useToolbarConfigOptions(
  ...
  const { configOptions, configOptionsStatus } = useCCbuddySessionStore(
    useShallow((state) => {
