...
import type { IUsageStatsService } from "@ccbuddy/services";
import type {
  CodingPlanResetScopeRequest,
  CodingPlanResetStatusSnapshot,
  CodingPlanResetType,
  CCbuddyAccountAccess,
  CCbuddyProviderAccountAccess,
} from "@ccbuddy/shared";
...
export function useCodingPlanQuotaResetUi({
  ...
  accountAccess?: CCbuddyProviderAccountAccess | CCbuddyAccountAccess | null;
  enabled?: boolean;
