...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@ccbuddy/shared";
import type { CCbuddyAutomationScheduleRule } from "@ccbuddy/shared";
...
function isScheduleRule(value: unknown): value is CCbuddyAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as CCbuddyAutomationScheduleRule)
    : undefined;
