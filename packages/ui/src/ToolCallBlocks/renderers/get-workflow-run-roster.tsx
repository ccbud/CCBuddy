 ...
 *
 * 一行的读法与模型面
 * （apps/ccbuddy-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）同一句话：
...
import type { ToolCallGetWorkflowRunDisplay } from "@ccbuddy/shared/ccbuddy-protocol-v4";
...
type FormatMessage = ReturnType<typeof useCCbuddyIntl>["intl"]["formatMessage"];
