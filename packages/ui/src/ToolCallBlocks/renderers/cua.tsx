...
import type { ApplicationIconRequest } from "@ccbuddy/shared";
import { useCCbuddyIntl } from "@/i18n/IntlProvider.js";
import { isCCbuddyCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_ccbuddy_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isCCbuddyCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useCCbuddyIntl>["intl"];
