import type { CCbuddyTaskGroupColor } from "@ccbuddy/services";
...
const TASK_GROUP_COLOR_CLASS: Record<CCbuddyTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<CCbuddyTaskGroupColor, string> = {
