...
import type { CCbuddyGroupedTaskViewNode, CCbuddyTaskGroupColor } from "@ccbuddy/services";
import {
...
export function GroupItem({
  ...
  getTaskRemoteSessionId: (task: CCbuddyTaskMeta) => string | undefined;
  getTaskWorkspaceLabel: (task: CCbuddyTaskMeta) => string;
  onSelectTask: (workspacePath: string, taskId: string, workspaceIdentity?: string) => void;
  onCloseTask: (task: CCbuddyTaskMeta) => void;
  onOpenFileTree?: (task: CCbuddyTaskMeta) => void;
  onCreateTask: () => void;
  ...
  onUpdateGroupColor: (groupId: string, color: CCbuddyTaskGroupColor) => void;
  onUngroupGroup: (groupId: string) => void;
  onMoveTaskToGroup: (task: CCbuddyTaskMeta, groupId: string | null) => void;
  onMoveTaskToTop: (task: CCbuddyTaskMeta) => void;
  onStartRenameTask: (task: CCbuddyTaskMeta) => void;
  onArchiveTask: (task: CCbuddyTaskMeta) => void;
  onMarkTaskAsUnread: (task: CCbuddyTaskMeta) => void;
  ...
  const handleGroupColorChange = useCallback(
    (color: string) => {
      onUpdateGroupColor(node.group.id, color as CCbuddyTaskGroupColor);
    },
