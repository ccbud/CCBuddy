...
//
// 旧草稿面（ccbuddySessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { modelSelectionSchema, type ModelSelection } from "@ccbuddy/shared";
import { submissionModeSchema, type SubmissionMode } from "@ccbuddy/shared/ccbuddy-protocol-v4";
...
const STORAGE_KEY_PREFIX = "ccbuddy-v4-composer-drafts:v1:";
