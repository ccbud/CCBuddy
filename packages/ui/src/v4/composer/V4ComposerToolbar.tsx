...
import type { ModelSelectionView } from "@ccbuddy/services";
...
import { useToolbarConfigOptions } from "@/hooks/useCCbuddyConfig.js";
...
function V4ComposerModelControlsImpl({
  ...
  const thoughtOption = useMemo<CCbuddyConfigOption | null>(() => {
...
import { isApiKeyAccess } from "@ccbuddy/provider";
