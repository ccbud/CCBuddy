...
import type { ShortcutCommandId, CCbuddyConfigOption } from "@ccbuddy/shared";
import {
...
function getChatToolbarShortcutKey(
  category: CCbuddyConfigOption["category"],
...
interface ToolbarShortcutState {
  ...
  modelOption?: CCbuddyConfigOption;
  modeOption?: CCbuddyConfigOption;
  thoughtOption?: CCbuddyConfigOption;
}
