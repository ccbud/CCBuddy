...
import { calibrateLocalTtftClock, localTtftNow } from "@ccbuddy/shared";
/* oxlint-disable eslint(max-lines) -- transport 将上传、分块读取和 runtime 生命周期保持在同一 host 边界。 */
// ConversationTransport 的 desktop/host 实现：桥到 ICCbuddyAgentService 的 v4 转发面
...
> &
  Partial<Pick<ICCbuddyAgentService, "onAgentRuntimeLifecycle">>;
