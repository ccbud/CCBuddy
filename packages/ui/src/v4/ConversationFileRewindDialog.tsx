...
import type { V4ConversationFileRewindPreviewResult } from "@ccbuddy/shared/ccbuddy-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useCCbuddyIntl>["intl"]) {
