...
const TASK_LIST_ROW_ACTIVITY_FIELD = "__ccbuddySessionActivity" as const;
...
export type TaskListMetaWithActivity = CCbuddyTaskMeta & {
  [TASK_LIST_ROW_ACTIVITY_FIELD]: TaskListRowActivity;
};

export function attachTaskListRowActivity<T extends CCbuddyTaskMeta>(
  task: T,
...
export function getTaskListRowActivity(task: CCbuddyTaskMeta): TaskListRowActivity | null {
...
function isTaskListRowRunning(task: CCbuddyTaskMeta): boolean {
 ...
 */
export function isTaskListRowActive(task: CCbuddyTaskMeta): boolean {
...
export function mergeTaskListMembershipFields(
  activityTask: CCbuddyTaskMeta,
  membershipTask: CCbuddyTaskMeta,
): CCbuddyTaskMeta {
