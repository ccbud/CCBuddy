...
import type { CCbuddyTaskClientMode } from "@ccbuddy/shared";
import {
  INITIAL_PANE_LAYOUT,
  MAX_WORKBENCH_PANES,
  V4_PRIMARY_PANE_ID,
...
const WORKBENCH_GROUP_STORAGE_KEY = "ccbuddy-v4-session-workbench-groups:v1";
...
interface WorkbenchGroupStore extends WorkbenchGroupSnapshot {
  configureClientMode: (clientMode: CCbuddyTaskClientMode) => void;
...
let workbenchGroupClientMode: CCbuddyTaskClientMode = "desktop-continuous";
