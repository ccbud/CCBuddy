...
function toRetryStatus(apiRetry: ApiRetryState): CCbuddyApiRetryStatus {
...
function TurnChatLoadingSlot({
  ...
  return (
    <div data-ccbuddy-chat-loading-slot="true" className="min-h-5">
      {visibleRetryStatus ? (
...
function ConversationTurnGroupImpl({
  ...
  const assistantCodeCommentCards = useMemo(
    () =>
      ...
      // 卡片与 ccbuddy-file-citation 的预览卡片保持一致：流式期间只投影正文，
