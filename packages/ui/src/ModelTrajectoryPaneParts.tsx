...
export type IntlShape = ReturnType<typeof useCCbuddyIntl>["intl"];
...
export function CallCard({
  ...
  record: CCbuddyModelTrajectoryRecord;
  index: number;
  inputMessages: CCbuddyModelTrajectoryMessage[];
...
function SourceTitle({ record, intl }: { record: CCbuddyModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<CCbuddyModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function sourceLabelId(
  callSource: NonNullable<CCbuddyModelTrajectoryRecord["callSource"]>,
): string {
...
function MessageBlock({
  ...
  message: CCbuddyModelTrajectoryMessage;
...
function ResponseBlock({
  ...
  response: NonNullable<CCbuddyModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
