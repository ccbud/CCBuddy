...
import type { CreateFeedbackTicketInput, FeedbackAttachmentKind } from "@ccbuddy/shared";
import type { FeedbackUploadProgress, IFeedbackService } from "@ccbuddy/services";
