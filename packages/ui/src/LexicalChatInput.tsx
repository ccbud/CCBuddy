...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __ccbuddyLexicalInputE2E?: typeof bridge }).__ccbuddyLexicalInputE2E === bridge
      ) {
        delete (input as { __ccbuddyLexicalInputE2E?: typeof bridge }).__ccbuddyLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__ccbuddyLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
