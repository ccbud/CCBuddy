...
const HIGHLIGHT_NAME = "ccbuddy-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "ccbuddy-model-trajectory-find-active";
const STYLE_ID = "ccbuddy-model-trajectory-find-highlight-style";
