...
import type { AccountProviderState } from "@ccbuddy/provider";
import type {
  OAuthProviderId,
...
async function refreshAccountProviderAccesses(params: {
  ...
  accesses: ReadonlyMap<string, CCbuddyProviderAccountAccess | CCbuddyAccountAccess>;
  ...
  try {
    ...
    const accesses = new Map(
      params.providerIds.flatMap((providerId) => {
        ...
        const query: CCbuddyProviderAccountAccess | CCbuddyAccountAccess =
