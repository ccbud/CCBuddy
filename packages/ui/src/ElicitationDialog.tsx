...
import type { CCbuddyElicitationQuestion, CCbuddyElicitationRequest } from "@ccbuddy/shared";
import type { InteractionAutoResolution } from "@ccbuddy/shared/ccbuddy-protocol-v4";
...
interface ElicitationDialogProps {
  request: CCbuddyElicitationRequest;
...
interface NormalizedElicitationQuestion extends CCbuddyElicitationQuestion {
  key: string;
}
...
function isPlanApprovalElicitationRequest(request: CCbuddyElicitationRequest): boolean {
