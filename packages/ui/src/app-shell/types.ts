...
import type { IFeedbackService, IServiceAccessor } from "@ccbuddy/services";
...
import type { WorkspaceCCbuddyUIState } from "@/store/ccbuddySessionStore.js";
...
export interface WorkspaceShellCCbuddyState {
  activeTaskId: WorkspaceCCbuddyUIState["activeTaskId"];
  draftFocusVersion: WorkspaceCCbuddyUIState["draftFocusVersion"];
  modelSwitchPending: WorkspaceCCbuddyUIState["modelSwitchPending"];
  modelSwitchStage: WorkspaceCCbuddyUIState["modelSwitchStage"];
  selectedProvider: WorkspaceCCbuddyUIState["selectedProvider"];
  optimisticTaskListByTaskId: WorkspaceCCbuddyUIState["optimisticTaskListByTaskId"];
  workspaceInit: WorkspaceCCbuddyUIState["workspaceInit"];
  taskStatus: CCbuddyTaskRuntimeStatus;
...
export type CreateTaskRequest = CCbuddyProvider | CreateTaskOptions;
...
export interface WorkspaceShellLayoutProps extends Omit<AppProps, "baseFeedbackService"> {
  ...
  workspaceTabs: Array<{
    ...
    remoteTarget?: import("@ccbuddy/shared").RemoteTarget;
    workspaceIdentity?: string;
  ...
  activeTaskProvider: CCbuddyProvider | null;
  resolvedActiveTaskMeta?: CCbuddyTaskMeta | null;
  ...
  handleStartDraftInWorkspace: (
    targetWorkspacePath: string,
    targetWorkspaceIdentity?: string,
    targetWorkspacePurpose?: import("@ccbuddy/shared").WorkspacePurpose,
    createSource?: SessionCreateSource,
  ) => void;
