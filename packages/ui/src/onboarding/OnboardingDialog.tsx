...
export function OnboardingDialog(props: {
  ...
  const onboardingDialogRequested = useCCbuddyStore((state) => state.onboardingDialogRequested);
  const clearOnboardingDialogRequest = useCCbuddyStore(
      ...
      const confirmed = await confirmDialog({
        ...
        description: intl.formatMessage(
          { id: "onboarding.agentsFile.confirmDescription" },
          {
            ...
            target: agentsFileMigration.status?.targetPath ?? "~/.ccbuddy/AGENTS.md",
          },
        ),
