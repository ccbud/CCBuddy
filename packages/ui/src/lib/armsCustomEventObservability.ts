import type { ArmsCustomEventPayload } from "@ccbuddy/shared";
...
type ArmsCustomEventDebugWindow = Window & {
  __ccbuddyArmsCustomEventsE2E?: ArmsCustomEventE2EEntry[];
};
...
export function recordArmsCustomEventForE2E(
  ...
  const buffer = (host.__ccbuddyArmsCustomEventsE2E ??= []);
  buffer.push({
    ...payload,
