import type { ProviderSettingsView } from "@ccbuddy/services";
import {
...
interface EntitledAccountProviderAccess {
  ...
  readonly access: CCbuddyProviderAccountAccess;
...
export function resolveEntitledAccountProviderAccess(
  ...
  const parsed = ccbuddyProviderAccountAccessSchema.safeParse(provider.effectiveConfig.access);
