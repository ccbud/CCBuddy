/**
 * ccbuddy-plan / Coding Plan 业务错误码与前端处理约定。
 *
 * | 场景           | code | HTTP | 前端处理 |
 * |----------------|------|------|----------|
 ...
 */
import { isOffPeakTicketExpiredError } from "@ccbuddy/shared";
...
const PROVIDER_BUSINESS_ERROR_MESSAGE_IDS: Record<ProviderBusinessErrorCode, string> = {
  "1006": "ccbuddy.error.providerBusiness.1006",
  "1005": "ccbuddy.error.providerBusiness.1005",
  "3006": "ccbuddy.error.providerBusiness.3006",
  "3002": "ccbuddy.error.providerBusiness.3002",
  "3001": "ccbuddy.error.providerBusiness.3001",
  "3007": "ccbuddy.error.providerBusiness.3007",
  "3008": "ccbuddy.error.providerBusiness.3008",
  "3009": "ccbuddy.error.providerBusiness.3009",
  "3010": "ccbuddy.error.providerBusiness.3010",
  "3102": "ccbuddy.error.providerBusiness.3102",
  "2007": "ccbuddy.error.providerBusiness.2007",
  "429": "ccbuddy.error.providerBusiness.429",
};
