  ...
  if (options.streaming) {
    ...
    if (unclosedStart !== null) {
      ...
      const prefixStart = findAssistantDirectivePrefixStart(
        content,
        [CODE_COMMENT_DIRECTIVE_NAME, "ccbuddy-file-citation"],
        protectedRanges,
        {
          minimumSingleColonPrefixLength: ":ccbuddy".length,
          singleColonDirectiveNames: ["ccbuddy-file-citation"],
          tripleColonDirectiveNames: ["ccbuddy-file-citation"],
        },
      );
      if (prefixStart !== null) {
