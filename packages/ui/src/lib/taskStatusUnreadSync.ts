...
import type { CCbuddyTaskMeta, CCbuddyWorkspaceTaskListChanged } from "@ccbuddy/shared";
...
import { getTaskUnreadIndicator, useCCbuddySessionStore } from "@/store/ccbuddySessionStore.js";
import { bumpTaskListMembershipVersion } from "@/v4/taskListMembershipVersion.js";
import { logger } from "@/logger.js";

type TaskUnreadService = Pick<ICCbuddyTaskService, "setTaskUnread">;
...
function buildStatusUnreadKey(event: CCbuddyWorkspaceTaskListChanged, taskId: string): string {
...
function shouldMarkStatusEventTaskUnread(params: {
  ...
  event: CCbuddyWorkspaceTaskListChanged;
}): boolean {
