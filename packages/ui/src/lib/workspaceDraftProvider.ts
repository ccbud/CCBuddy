...
interface ResolveWorkspaceSwitchDraftProviderOptions {
  currentSelectedProvider: CCbuddyProvider;
  targetWorkspacePath: string;
  targetWorkspaceIdentity?: string;
  workspaces: Record<string, WorkspaceCCbuddyUIState | undefined>;
}
...
export function resolveWorkspaceSwitchDraftProvider({
  ...
  workspaces,
}: ResolveWorkspaceSwitchDraftProviderOptions): CCbuddyProvider {
