...
export type ModelConfigMissingUiError = CCbuddyError & {
...
export function isProviderNotReadyError(error: unknown): boolean {
  return normalizeUnknownError(error).code === CCBUDDY_AGENT_PROVIDER_NOT_READY_CODE;
}
