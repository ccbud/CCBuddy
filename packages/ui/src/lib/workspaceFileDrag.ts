...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-ccbuddy-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "ccbuddy:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "ccbuddy:workspace-file-drag-state";
