const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "ccbuddy-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "ccbuddy-notification-sound-enabled";
