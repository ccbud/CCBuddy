...
function hasOwnTaskMetaField<T extends keyof CCbuddyTaskMeta>(task: CCbuddyTaskMeta, key: T) {
...
export function mergeTaskWithOptimisticMeta(
  ...
  optimisticTask: CCbuddyTaskMeta,
): CCbuddyTaskMeta {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<CCbuddyTaskMeta | null | undefined>
): CCbuddyTaskMeta | undefined {
  let merged: CCbuddyTaskMeta | undefined;
