...
import type { CommandAck, WorkflowRunState } from "@ccbuddy/shared/ccbuddy-protocol-v4";
...
import { encodeCustomModelValue } from "@/lib/ccbuddyCustomModelValue.js";
...
function WorkflowRunSettingsForm({
  ...
  const groups = useMemo(
    () =>
      view === null
        ? []
        : buildRegistryModelSelectGroups(CCBUDDY_AGENT_PROVIDER, view, {
