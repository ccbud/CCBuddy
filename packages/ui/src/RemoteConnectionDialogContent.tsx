...
import { TID_REMOTE_KIND_DOCKER, TID_REMOTE_KIND_SSH, TID_REMOTE_KIND_WSL } from "@ccbuddy/shared";
import type {
  IMcpSyncService,
  IPluginSyncService,
  IServiceAccessor,
...
export function RemoteConnectionDirectoryStep({
  ...
  localCCbuddyAgentService?: ICCbuddyAgentService;
  remoteCCbuddyAgentService?: ICCbuddyAgentService | null;
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-6 h-full" aria-busy={selecting}>
      ...
      <RemoteSyncDialogs
        ...
        localCCbuddyAgentService={localCCbuddyAgentService}
        remoteCCbuddyAgentService={remoteCCbuddyAgentService}
