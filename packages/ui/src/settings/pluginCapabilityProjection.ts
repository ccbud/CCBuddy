...
import { compareDocumentPluginPriority, isPluginCommand, isUserCommand } from "@ccbuddy/shared";
...
export function selectBuiltInPlugins(
  ...
  installedPlugins: readonly CCbuddyInstalledPluginSummary[],
): CCbuddyPluginInfo[] {
...
interface PluginSettingsGroups {
  installed: CCbuddyPluginInfo[];
  builtIn: CCbuddyPluginInfo[];
}
...
export function selectPluginsForScope(
  plugins: readonly CCbuddyPluginInfo[],
  _installedPlugins: readonly CCbuddyInstalledPluginSummary[],
  _scope: CCbuddyPluginScope,
): CCbuddyPluginInfo[] {
...
export function selectSkillsForScope(
  ...
  scopedPlugins: readonly Pick<CCbuddyPluginInfo, "id" | "name" | "enabled">[],
...
export function selectCommandsForScope(
  commands: readonly CCbuddyCommand[],
  scopedPlugins: readonly Pick<CCbuddyPluginInfo, "id" | "name" | "enabled">[],
  scope: CCbuddyPluginScope,
): CCbuddyCommand[] {
  const enabledPlugins = scopedPlugins.filter((plugin) => plugin.enabled);
