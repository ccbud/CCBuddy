...
import type { CCbuddySavedWorkflowRun, CCbuddySavedWorkflowRunStatus } from "@ccbuddy/shared";
...
): Map<string, CCbuddySavedWorkflowRun> {
  const byName = new Map<string, CCbuddySavedWorkflowRun>();
...
export function savedWorkflowRunDurationMs(run: CCbuddySavedWorkflowRun, now: number): number {
