...
import type { CCbuddySavedWorkflowArgType } from "@ccbuddy/shared";
...
const ARG_TYPES: readonly CCbuddySavedWorkflowArgType[] = ["string", "number", "boolean", "json"];
          ...
          >
            <div className={cn("grid items-center gap-3", columns)}>
              ...
              <Select
                value={row.type}
                onValueChange={(value) =>
                  onChange(row.key, { type: value as CCbuddySavedWorkflowArgType })
                }
              >
