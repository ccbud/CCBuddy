...
import type {
  CCbuddySavedWorkflowArgType,
  CCbuddySavedWorkflowArgsDeclaration,
} from "@ccbuddy/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: CCbuddySavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: CCbuddySavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: CCbuddySavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: CCbuddySavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: CCbuddySavedWorkflowArgsDeclaration = {};
