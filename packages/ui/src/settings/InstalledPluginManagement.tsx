...
import type { CCbuddyPluginDiagnostic, CCbuddyPluginInfo } from "@ccbuddy/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: CCbuddyPluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<CCbuddyPluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<CCbuddyPluginInfo["hookDetails"]>[number]): string {
