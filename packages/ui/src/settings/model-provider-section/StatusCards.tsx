...
export function CodingPlanStatusPanel({
  ...
  quotaResetAccountAccess?: CCbuddyProviderAccountAccess | CCbuddyAccountAccess;
        ...
        {cards.map((card) => (
          <PlanUsageMetricCard
            ...
            infoDescription={
              card.key === "serverMcp"
                ? intl.formatMessage({
                    id: "sidebar.usage.plan.ccbuddyMcpDescription",
                  })
                : undefined
            }
          ...
          {infoDescription ? (
            <ControlHintTooltip title={infoDescription} standalone>
              <button
                ...
                data-ccbuddy-mcp-info="model-settings"
              >
