...
interface OffPeakEditViewProps {
  editing: CCbuddyOffPeakTask | null;
  ...
  onDelete?: (task: CCbuddyOffPeakTask) => void;
  onDeleteHistory?: (task: CCbuddyOffPeakTask) => void;
  onPause?: (task: CCbuddyOffPeakTask) => void;
  onContinue?: (task: CCbuddyOffPeakTask) => void;
...
export function OffPeakEditView({
  ...
  const thoughtLevelOption = useMemo<CCbuddyConfigOption | null>(
    () =>
    ...
    >
      ...
      {tab === "history" ? (
        <OffPeakHistoryTab
          ...
          {...(onOpenSession
            ? {
                onOpenSession: (task: CCbuddyOffPeakTask) =>
                  task.sessionId
                    ? onOpenSession({
