import type { CCbuddyPluginComponentKind } from "@ccbuddy/shared";
...
export interface PluginComponentDisplayGroup {
  kind: CCbuddyPluginComponentKind;
...
const COMPONENT_BADGE_STYLES: Record<CCbuddyPluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<CCbuddyPluginComponentKind, string> = {
