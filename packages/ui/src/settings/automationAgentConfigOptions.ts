import type { CCbuddyConfigOption, CCbuddyProvider } from "@ccbuddy/shared";
...
export function buildAutomationModeOption(currentValue: string): CCbuddyConfigOption {
  return {
    id: "mode",
    name: "Mode",
    category: "mode",
...
export function resolveAutomationModelItem(
  ...
  // workspace runtime 也可能返回 ccbuddy-openai-compatible/model 这类包装值，provider 对不上时
...
export function buildAutomationThoughtLevelOption(
  runtimeOption: CCbuddyConfigOption | undefined,
  currentValue: string,
