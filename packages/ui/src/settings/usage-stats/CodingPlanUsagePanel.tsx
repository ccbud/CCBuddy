...
import { BUILTIN_MODEL_PROVIDER_IDS } from "@ccbuddy/shared";
...
function CodingPlanQuotaCards({
  ...
  accountAccess:
    | import("@ccbuddy/shared").CCbuddyProviderAccountAccess
    | import("@ccbuddy/shared").CCbuddyAccountAccess
    | undefined;
                ...
                {card.key === "serverMcp" ? (
                  ...
                  >
                    <button
                      ...
                      data-ccbuddy-mcp-info="usage-stats"
                    >
