...
import { TID_PLUGIN_STORE_BROWSE } from "@ccbuddy/shared";
import type {
  CCbuddyPluginInfo,
  CCbuddyPluginScope,
...
function PluginList({
  ...
  const getPluginOptionValue = (
    ...
    key: string,
    option: CCbuddyPluginUserConfigOption,
  ...
  const savePluginOptions = async (plugin: CCbuddyPluginInfo) => {
  ...
  const renderPluginRows = (items: CCbuddyPluginInfo[]) => (
  ...
  return (
    <section className="space-y-6" aria-labelledby="plugin-installed-title">
      ...
      <RemoteSyncDialogs
        ...
        remoteCCbuddyAgentService={targetServiceResolution.services.ccbuddyAgentService}
