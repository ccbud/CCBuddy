...
import type { CommandConfig, UserCommand, CCbuddyCommand } from "@ccbuddy/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: CCbuddyCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: CCbuddyCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? CCBUDDY_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}
