...
import type { UserCommand, CCbuddyCommand } from "@ccbuddy/shared";
import { isPluginCommand, isUserCommand } from "@ccbuddy/shared";
...
export function isEditableUserCommand(command: CCbuddyCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "ccbuddy";
}

interface CommandCardProps {
  command: CCbuddyCommand;
  onEdit?: (command: CCbuddyCommand) => void;
  onToggle?: (command: CCbuddyCommand, enabled: boolean) => void;
  isOperating?: boolean;
