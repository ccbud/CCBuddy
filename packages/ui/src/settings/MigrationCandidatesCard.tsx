...
import type {
  ...
  CCbuddyImportedSessionSkippedItem,
} from "@ccbuddy/shared";
...
function ImportIssuesList({
  ...
  title: string;
  items: CCbuddyImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: CCbuddyImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: CCbuddyImportSessionsResult | null;
  isImporting: boolean;
