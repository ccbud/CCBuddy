import type { McpServerConfig, CCbuddyMcpServer } from "@ccbuddy/shared";

export const MCP_SECTIONS = ["ccbuddyagentmcp"] as const;
...
export function serverToForm(server: CCbuddyMcpServer): FormState {
...
// 与 shared 层 convertToCCbuddyAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
