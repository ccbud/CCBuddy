...
import type { McpSource, CCbuddyMcpServer } from "@ccbuddy/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: CCbuddyMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: CCbuddyMcpServer) => void;
}) {
  const { intl } = useCCbuddyIntl();
