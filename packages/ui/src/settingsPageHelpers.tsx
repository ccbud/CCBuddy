...
export type { Locale, LocalePreference } from "@ccbuddy/shared";
...
const CCBUDDY_INTERACTION_BEHAVIOR_OPTIONS: readonly CCbuddyInteractionBehavior[] = [
  "queue",
  "guide",
];
...
export function GeneralSectionContent({
  ...
  onCCbuddyInteractionBehaviorChange: (behavior: CCbuddyInteractionBehavior) => Promise<void>;
  ...
  return (
    <div className="space-y-4">
      ...
      <SettingsGroupCard>
        <SettingsRow
          label={intl.formatMessage({ id: "settings.ccbuddyInteractionBehavior" })}
          description={intl.formatMessage({
            id: "settings.ccbuddyInteractionBehaviorDescription",
          })}
          control={
            <Select
              value={ccbuddyInteractionBehavior}
              onValueChange={(value) => {
                void onCCbuddyInteractionBehaviorChange(value as CCbuddyInteractionBehavior);
              }}
            >
              <SelectTrigger size="lg" className="w-[260px] min-w-0 justify-between">
                <SelectValue />
              ...
              <SelectContent>
                {CCBUDDY_INTERACTION_BEHAVIOR_OPTIONS.map((behavior) => (
                  <SelectItem key={behavior} value={behavior}>
                    {intl.formatMessage({
                      id: `settings.ccbuddyInteractionBehavior.option.${behavior}`,
                    })}
                  </SelectItem>
                ))}
              </SelectContent>
