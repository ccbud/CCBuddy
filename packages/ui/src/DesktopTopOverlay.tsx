import type { IPlatformService, UpdateStatePayload } from "@ccbuddy/shared";
      ...
      >
        ...
        >
          {usesCustomCaptionArea && (
            ...
            >
              <CCbuddyAboutLogo className="size-5 transition-opacity duration-150 group-hover:opacity-0" />
