...
import { unpackWorkspaceFileEntries } from "@ccbuddy/shared/workspaceFileEntriesCodec";
...
type TaskSearchResultItem = CCbuddyTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = CCbuddyTaskChangeSummary["files"][number];
...
function getTaskTitle(task: CCbuddyTaskMeta, untitledLabel: string): string {
