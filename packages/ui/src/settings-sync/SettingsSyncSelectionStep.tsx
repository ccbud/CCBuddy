...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@ccbuddy/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useCCbuddyIntl>["intl"]): string {
  switch (agent) {
    case "ccbuddy":
      return intl.formatMessage({ id: "settingsSync.agent.ccbuddy" });
    case "claudeCode":
