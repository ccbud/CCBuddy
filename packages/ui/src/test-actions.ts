...
export interface TestActions extends TaskListE2EActions {
  ...
  /** E2E 通过真实 ccbuddyAgentService 拉取插件 overview */
  getPluginsOverview: ICCbuddyAgentService["getPluginsOverview"];
  /** E2E 通过真实 ccbuddyAgentService 添加 marketplace */
  addPluginMarketplace: ICCbuddyAgentService["addPluginMarketplace"];
  /** E2E 通过真实 ccbuddyAgentService 刷新 marketplace */
  updatePluginMarketplace: ICCbuddyAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 ccbuddyAgentService 安装 marketplace plugin */
  installPlugin: ICCbuddyAgentService["installPlugin"];
  /** E2E 通过真实 ccbuddyAgentService 触发插件 discover */
  listPlugins: ICCbuddyAgentService["listPlugins"];
  /** E2E 通过真实 ccbuddyAgentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: ICCbuddyAgentService["getPluginReferenceCatalog"];
}
