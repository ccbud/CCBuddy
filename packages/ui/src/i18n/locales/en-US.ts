...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like CCbuddy to show its work?",
  ...
  "occupationOnboarding.memoryDescription":
    "Let CCbuddy remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting CCbuddy",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen CCbuddy.",
  ...
  "startup.global.starting_services": "Starting CCbuddy",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "CCbuddy will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another CCbuddy or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen CCbuddy. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen CCbuddy to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen CCbuddy.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a CCbuddy restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into CCbuddy",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to CCbuddy and try again",
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to CCbuddy bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "CCbuddy saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "CCbuddy uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to CCbuddy.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to CCbuddy's `/api/bots/webhook` endpoint.",
  ...
  "bots.setup.guide.webhook.bind.3":
    "If the bot uses a secret, also send `x-ccbuddy-bot-secret`; then return here after the bind succeeds.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another CCbuddy window.",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to CCbuddy",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to CCbuddy",
  "login.description": "Connect your account to start using CCbuddy",
  ...
  "logout.confirm.title": "Disconnect and restart CCbuddy?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only CCbuddy Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About CCbuddy",
  ...
  "titleBar.menu.help.toggleCCbuddyStdioTap": "Capture agent stdio traffic",
  ...
  "forceUpdate.title": "Update CCbuddy to continue",
  ...
  "workspace.openHistoryTimeline": "Calendar / Timeline",
  "workspace.openHistorySessions": "Sessions",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart CCbuddy to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the CCbuddy CDN and have download, extract, and checksum tools.",
  ...
  "webRemoteControl.description": "Control CCbuddy workspaces through chat bots.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "CCbuddy checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the CCbuddy terminal font.",
  ...
  "settings.ccbuddyInteractionBehavior": "Interaction behavior",
  "settings.ccbuddyInteractionBehaviorDescription":
    "While CCbuddy is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.ccbuddyInteractionBehavior.option.queue": "Queue",
  "settings.ccbuddyInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .ccbuddy/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the CCbuddy installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching CCbuddy task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by CCbuddy",
  ...
  "resourceManager.storage.diskUsage": "CCbuddy uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the CCbuddy desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "CCbuddy could not verify its Windows secure import component. Reinstall or update CCbuddy before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, CCbuddy will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by CCbuddy Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "CCbuddy provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This CCbuddy Agent cannot refresh OAuth status. Upgrade or restart CCbuddy, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to CCbuddy to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into CCbuddy",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to CCbuddy 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by CCbuddy automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in CCbuddy.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. CCbuddy uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in CCbuddy after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "CCbuddy MCP",
  ...
  "sidebar.usage.plan.mcp": "CCbuddy MCP",
  "sidebar.usage.plan.ccbuddyMcp": "CCbuddy MCP",
  "sidebar.usage.plan.ccbuddyMcpDescription":
    "Daily aggregate quota for CCbuddy built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into CCbuddy. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. CCbuddy follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into CCbuddy",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by CCbuddy Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend CCbuddy with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into CCbuddy and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. CCbuddy follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into CCbuddy",
  ...
  "settings.commands.description":
    "Manage CCbuddy Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.ccbuddyAgent": "CCbuddy Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into CCbuddy. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. CCbuddy follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into CCbuddy",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .ccbuddyignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".ccbuddyignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the CCbuddy data directory only after saving.",
  ...
  "settings.workspaceFileSearch.revealHint":
    "Save first; .ccbuddyignore is stored in CCbuddy workspace data",
  ...
  "settingsSync.action.finish": "Start using CCbuddy",
  "settingsSync.agent.ccbuddy": "CCbuddy Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current CCbuddy settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to CCbuddy",
  ...
  "onboarding.welcome.title": "Welcome to CCbuddy",
  "onboarding.welcome.start": "Start CCbuddy",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while CCbuddy imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "CCbuddy will copy {source} to {target}.\nIf the target file already exists, the CCbuddy default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask CCbuddy anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask CCbuddy anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, CCbuddy will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want CCbuddy to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart CCbuddy app and retry, or ask CCbuddy to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with CCbuddy in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for CCbuddy: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with CCbuddy in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current CCbuddy Agent session",
  ...
  "chat.error.noAvailableModel":
    "No model available. Configure your own model service to continue.",
  ...
  "chat.quota.mcp.quotaExhausted":
    'CCbuddy MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No CCbuddy MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  // CCbuddy Agent
  "ccbuddy.unavailable": "AI agent not available",
  "ccbuddy.initFailed": "Failed to start AI agent",
  "ccbuddy.error.TASK_OWNED_BY_OTHER_HOST":
    "This task is already running in another connected view.",
  "ccbuddy.error.STALE_TASK_OWNER_COMMAND": "This action belongs to an older run and was ignored.",
  "ccbuddy.error.NO_ACTIVE_TASK_OWNER": "No active task owner is available for this action.",
  "ccbuddy.error.OWNER_COMMAND_FAILED": "The task owner could not complete this action.",
  "ccbuddy.error.MEDIA_BUDGET_CURRENT_ATTACHMENT_TOO_LARGE":
    "Current attachments are too large for one request. Remove or compress attachments and try again.",
  "ccbuddy.error.MEDIA_BUDGET_CURRENT_IMAGE_TOO_LARGE":
    "Current image attachments are too large. Remove or compress images and try again.",
  "ccbuddy.error.MEDIA_BUDGET_CURRENT_VIDEO_TOO_LARGE":
    "Current video attachments are too large. Remove or compress videos and try again.",
  "ccbuddy.error.CCBUDDY_RUNTIME_MODEL_UNAVAILABLE":
    "The current model is no longer available. Select an available model from the current model list to continue.",
  "ccbuddy.error.CCBUDDY_BIGMODEL_TEAM_PLAN_MEMBER_REQUIRED":
    "The current model is unavailable. Check your model service configuration.",
  "ccbuddy.error.providerBusiness.1006":
    "Model service authentication failed. Check the credentials you configured.",
  "ccbuddy.error.providerBusiness.1005":
    "Your model service reports that its quota is exhausted. Check your service allowance or choose another model.",
  "ccbuddy.error.providerBusiness.3006":
    "The model service rejected this model. Check your configuration or choose another model.",
  "ccbuddy.error.providerBusiness.3002":
    "You're sending requests too quickly. Please try again later.",
  "ccbuddy.error.providerBusiness.3001":
    "The request parameters are invalid. Check the input and try again.",
  "ccbuddy.error.providerBusiness.3007":
    "The request was rejected by the gateway security check. Please try again later or contact support.",
  "ccbuddy.error.providerBusiness.3008":
    "The model service is busy. Switch models or try again later.",
  "ccbuddy.error.providerBusiness.3009":
    "The model service is busy. Switch models or try again later.",
  "ccbuddy.error.providerBusiness.3010":
    "The model service is busy. Switch models or try again later.",
  "ccbuddy.error.providerBusiness.3102":
    "This run exceeded the maximum single-run time. Create a new off-peak task to continue.",
  "ccbuddy.error.modelSuspiciousEmpty":
    "The model returned no content (often caused by an expired token or plan issues). Please send again.",
  "ccbuddy.error.providerBusiness.2007":
    "The upstream service is temporarily unavailable. Please try again later.",
  "ccbuddy.error.providerBusiness.429":
    "You're sending requests too quickly. Please try again later.",
  ...
  "resourceManager.appUsage": "CCbuddy",
  ...
  "feedback.submit.template.section.copyErrorHeading": "CCbuddy Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while CCbuddy is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task CCbuddy can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "CCbuddy Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "CCbuddy Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart CCbuddy",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart CCbuddy to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified CCbuddy plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "CCbuddy will verify the Computer Use tools against the exact session when your first session starts.",
