import type { CCbuddyModelTrajectoryMessage } from "@ccbuddy/services";
...
type IntlShape = ReturnType<typeof useCCbuddyIntl>["intl"];
...
function compactTextPreview(message: CCbuddyModelTrajectoryMessage): string {
...
function firstLinePreview(message: CCbuddyModelTrajectoryMessage): string {
...
function messageClipboardText(message: CCbuddyModelTrajectoryMessage): string {
