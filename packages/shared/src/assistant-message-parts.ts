export type CCbuddyAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly CCbuddyAssistantMessagePart[] | undefined,
  nextPart: CCbuddyAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly CCbuddyAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly CCbuddyAssistantMessagePart[]) {
