...
export type CommandAgentSource = "ccbuddyAgent";
...
export type CCbuddyCommand = UserCommand | PluginCommand;

export function isUserCommand(command: CCbuddyCommand): command is UserCommand {
  return command.source === "user";
}

export function isPluginCommand(command: CCbuddyCommand): command is PluginCommand {
