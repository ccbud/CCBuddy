...
import { CCBUDDY_ENV } from "./env.js";
import { buildBigModelCodingPlanTeamManageUrl } from "./ccbuddyEndpoint.js";
...
export const MODEL_PROVIDER_FAMILY_SPECS = [
  ...
  },
  {
    ...
    teamCodingPlanManageUrl: buildBigModelCodingPlanTeamManageUrl({ CCBUDDY_ENV }),
  },
