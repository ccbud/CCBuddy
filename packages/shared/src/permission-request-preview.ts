import type { CCbuddyPermissionRequest } from "./ccbuddy-task-types-core.js";
...
const FILE_PATH_KEYS = new Set([
  ...
  "paths",
  "file",
  // CCbuddy Agent edit 权限常把目标文件放在 file_path/filePath，漏掉会让权限预览只剩标题。
  "file_path",
  "filepath",
  "files",
  "filename",
...
function readPermissionInputSource(rawSource: unknown): unknown {
  ...
  // CCbuddy protocol 的 requestPermission schema 使用 input 承载工具参数；
