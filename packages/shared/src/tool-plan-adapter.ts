import type { CCbuddyPlanStep } from "./ccbuddy-task-types-core.js";
...
function normalizePlanStatus(value: unknown): CCbuddyPlanStep["status"] | null {
...
function parsePlanStep(value: unknown, index: number): CCbuddyPlanStep | null {
...
function extractPlanStepsFromValue(value: unknown): CCbuddyPlanStep[] | null {
  ...
  const steps = collection
    ...
    .filter((step): step is CCbuddyPlanStep => step !== null);
