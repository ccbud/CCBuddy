 ...
 */
export const CCBUDDY_DYNAMIC_WORKFLOW_MODE_ENV = "CCBUDDY_DYNAMIC_WORKFLOW_MODE";
...
export function resolveDynamicWorkflowClientConfig(input: {
  ...
  const override = normalizeDynamicWorkflowMode(input.env?.[CCBUDDY_DYNAMIC_WORKFLOW_MODE_ENV]);
