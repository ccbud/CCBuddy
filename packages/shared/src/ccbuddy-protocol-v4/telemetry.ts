import { z } from "zod";
import { ccbuddySyntheticUserMessageSourceSchema } from "../ccbuddy-protocol-legacy-types.js";
...
const turnStartedFactSchema = z
  .object({
    ...
    inputSource: ccbuddySyntheticUserMessageSourceSchema.optional(),
...
const toolLifecycleFactSchema = z
  .object({
    ...
    skillSource: z.enum(["agents", "ccbuddy", "bundled", "plugin", "remote"]).optional(),
...
type TurnStartedConversationTelemetryFact = Extract<
  ...
  { kind: "turn.started" }
> &
  import("../ccbuddy-task-types-core.js").CCbuddyBackgroundTurnAttribution;
