...
export const desktopMenuMessageIds = {
  ...
  helpToggleCCbuddyStdioTap: "titleBar.menu.help.toggleCCbuddyStdioTap",
  helpCCbuddyEndpoint: "titleBar.menu.help.ccbuddyEndpoint",
  helpCCbuddyEndpointProduction: "titleBar.menu.help.ccbuddyEndpoint.production",
  helpCCbuddyEndpointTest: "titleBar.menu.help.ccbuddyEndpoint.test",
  helpCCbuddyEndpointCustom: "titleBar.menu.help.ccbuddyEndpoint.custom",
  helpCCbuddyEndpointReset: "titleBar.menu.help.ccbuddyEndpoint.reset",
  ...
  trayOpenCCbuddy: "tray.menu.openCCbuddy",
...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  "zh-CN": {
    ...
    "titleBar.menu.help.ccbuddyEndpoint": "CCbuddy Endpoint",
    "titleBar.menu.help.ccbuddyEndpoint.production": "Production（默认）",
    "titleBar.menu.help.ccbuddyEndpoint.test": "Test",
    "titleBar.menu.help.ccbuddyEndpoint.custom": "自定义...",
    "titleBar.menu.help.ccbuddyEndpoint.reset": "恢复默认",
    ...
    "tray.tooltip": "CCbuddy",
    "tray.menu.openCCbuddy": "打开 CCbuddy",
    "tray.menu.quit": "退出",
  },
  "en-US": {
    ...
    "titleBar.menu.help.ccbuddyEndpoint": "CCbuddy Endpoint",
    "titleBar.menu.help.ccbuddyEndpoint.production": "Production (default)",
    "titleBar.menu.help.ccbuddyEndpoint.test": "Test",
    "titleBar.menu.help.ccbuddyEndpoint.custom": "Custom...",
    "titleBar.menu.help.ccbuddyEndpoint.reset": "Reset to default",
    ...
    "tray.tooltip": "CCbuddy",
    "tray.menu.openCCbuddy": "Open CCbuddy",
    "tray.menu.quit": "Quit",
  },
};
