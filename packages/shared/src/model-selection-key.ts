...
export function buildNativeSupplierKey(ccbuddyProvider: CCbuddyProvider): string {
  return `${NATIVE_SUPPLIER_KEY_PREFIX}${ccbuddyProvider}`;
}
...
export function buildGhostSupplierKey(
  ccbuddyProvider: CCbuddyProvider,
...
export function resolveSupplierKeyFromModelDisplayValue(
  ...
  return buildNativeSupplierKey(ccbuddyProvider);
}
