...
export const CCBUDDY_FILE_LOCK_TIMEOUT_ERROR_CODE = "CCBUDDY_FILE_LOCK_TIMEOUT" as const;
...
export function isCCbuddyFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === CCBUDDY_FILE_LOCK_TIMEOUT_ERROR_CODE;
}
