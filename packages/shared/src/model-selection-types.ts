export const CCBUDDY_AGENT_PROVIDER_NOT_READY_CODE = "CCBUDDY_AGENT_PROVIDER_NOT_READY" as const;
export const CCBUDDY_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
