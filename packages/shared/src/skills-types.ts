...
export interface SkillSummary {
   ...
   * 软链导入的技能里 `path` 是 realpath 后的目标文件，`sourcePath` 才指向 `~/.ccbuddy/skills/<name>` 下的链接本体，
...
/** 与 ccbuddy-cli `SkillDiagnosticCode` 同步。变动时一并改 apps/ccbuddy-cli/packages/contracts/src/skills/index.ts。 */
