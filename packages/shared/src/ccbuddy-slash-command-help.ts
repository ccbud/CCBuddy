export type BuiltinCCbuddySlashCommandHelpEntry = {
...
export const BUILTIN_CCBUDDY_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinCCbuddySlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.ccbuddy/AGENTS.md.",
      ],
      name: "init",
