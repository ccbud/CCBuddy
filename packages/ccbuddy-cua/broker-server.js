...
export const HELPER_ADDON_ENV = "CCBUDDY_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "ccbuddy-cua-windows-dev/v1";
...
export function isPotentialCCbuddyCuaAgentMcpServer(_server) {
  return false;
}
