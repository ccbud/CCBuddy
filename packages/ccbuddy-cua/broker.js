...
export const BROKER_SOCKET_ENV = "CCBUDDY_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "CCBUDDY_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `ccbuddy-cua-broker-${randomUUID()}.sock`);
}
