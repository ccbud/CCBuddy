...
extension Color {
    ...
    static let ccConversationListHover = adaptive(light: 0xEDEDEA, dark: 0x2A2A28)
    static let ccConversationSecondary = adaptive(light: 0xE8E8E5, dark: 0x30302E)
    static let ccSidebarSelection = adaptive(light: 0xDEDEDA, dark: 0x343432)
    static let ccForeground = adaptive(light: 0x1D1D1F, dark: 0xF0EFED)
    static let ccMuted = adaptive(light: 0x686761, dark: 0xA9A8A2)
    static let ccCaption = adaptive(light: 0x686761, dark: 0xA9A8A2)
    static let ccBorder = adaptive(light: 0xE3E3DF, dark: 0x353431)
