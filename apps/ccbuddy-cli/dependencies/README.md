...
This directory contains versioned third-party artifacts required by CCbuddy packaging.
...
pnpm --filter @ccbuddy/desktop prepare:native-search

# Prepare a specific target, optionally into a separate staging directory.
node scripts/prepare-native-search-tools.mjs --platform linux --arch x64 --output-dir /tmp/ccbuddy-native-search
