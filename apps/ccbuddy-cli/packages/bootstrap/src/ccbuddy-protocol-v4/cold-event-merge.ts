...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@ccbuddy/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@ccbuddy/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@ccbuddy/contracts").MessageId;
      keptMessageIDs?: import("@ccbuddy/contracts").MessageId[];
      targetMessageID?: import("@ccbuddy/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@ccbuddy/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@ccbuddy/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@ccbuddy/contracts").SessionId;
