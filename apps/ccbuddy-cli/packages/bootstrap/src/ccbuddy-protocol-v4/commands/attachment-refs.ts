...
// 1. URI ref（ccbuddy-artifact:// 等带 scheme:/）——经 attachment chunk transaction 寄存的内容引用：
...
import type { TurnAttachment } from "@ccbuddy/core";
...
async function mapAttachmentRef(app: CCbuddyApp, ref: AttachmentRef): Promise<TurnAttachment> {
