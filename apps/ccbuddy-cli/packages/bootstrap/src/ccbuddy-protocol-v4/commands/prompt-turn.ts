...
import { type TurnBackgroundAttribution, type TurnInputIntentMetadata } from "@ccbuddy/contracts";
...
import { runWithSessionResidencyFinalization } from "../../ccbuddy-protocol/session-residency.js";
