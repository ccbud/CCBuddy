import type { PermissionOptionsPolicy, PermissionUpdate } from "@ccbuddy/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type CCbuddyPermissionOption } from "@ccbuddy/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 ccbuddyPermissionUpdateSchema 是 strict，会话语义由
