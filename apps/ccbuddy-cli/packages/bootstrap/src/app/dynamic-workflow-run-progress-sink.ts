...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@ccbuddy/contracts";
 ...
 *
 *   CCbuddyApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
