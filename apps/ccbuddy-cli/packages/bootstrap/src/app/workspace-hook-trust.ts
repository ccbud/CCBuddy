import { createDefaultFileWorkspaceHookTrustStore } from "@ccbuddy/adapters/storage";
import {
...
import { SessionEventType } from "@ccbuddy/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@ccbuddy/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.ccbuddy/security。 */
  homeDir?: string;
