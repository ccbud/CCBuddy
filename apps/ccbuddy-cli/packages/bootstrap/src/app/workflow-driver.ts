...
// ============================================================
// 把 dynamic-workflow 引擎核心的向下副作用端口 WorkflowDriver 落到真实 CCbuddy AgentRuntime 上：
...
import type { SessionId, WorkflowEscalatePort } from "@ccbuddy/contracts";
import type { TurnResult } from "@ccbuddy/core";
import {
