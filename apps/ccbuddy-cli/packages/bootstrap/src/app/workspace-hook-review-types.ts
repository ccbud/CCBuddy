...
import type { WorkspaceHookRuntimeAdmissionPort, WorkspaceHookTrustCoordinator } from "@ccbuddy/core";
import type { WorkspaceHookReviewRequestPayload } from "@ccbuddy/shared/ccbuddy-protocol-v4";
