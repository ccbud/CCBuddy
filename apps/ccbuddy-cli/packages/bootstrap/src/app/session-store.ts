...
import { SqliteSessionStore } from "@ccbuddy/adapters/storage";
import { resolvePath, type ConfigResult } from "@ccbuddy/adapters/config";
import {
...
import type { ModelSelection } from "@ccbuddy/provider";
...
export async function openStartupSessionStore(
  ...
  startupTimer.start("CCbuddy SQLite migration started", {
    context: { dbPath },
  ...
  startupTimer.mark("CCbuddy SQLite migration completed", {
    context: { dbPath },
