import type { McpServerConfig, PluginLoadOutcome } from "@ccbuddy/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { CCBUDDY_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { CCBUDDY_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },
