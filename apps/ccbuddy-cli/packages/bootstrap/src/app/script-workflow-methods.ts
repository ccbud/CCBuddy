import type { SubmitPromptOptions, CCbuddyApp } from "./types.js";
import {
...
export function createScriptWorkflowBridge(deps: ScriptWorkflowBridgeDeps): ScriptWorkflowBridge {
  ...
  return {
    ...
    workflowPort: createScriptWorkflowToolPort({
      ...
      workspaceIdentity: deps.runtimeConfig.memory?.workspaceIdentity,
    }),
  };
}
...
function toRuntimeOptions(
  options: Parameters<NonNullable<CCbuddyApp["runWorkflowScript"]>>[1],
