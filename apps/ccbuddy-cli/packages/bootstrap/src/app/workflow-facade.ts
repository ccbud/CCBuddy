...
import { createNodeExecutionAdapter } from "@ccbuddy/adapters/exec";
...
} from "@ccbuddy/adapters/workflow";
import {
  AgentRuntime,
...
import type { PrepareUserExecutionBoundary, CCbuddyAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "ccbuddy-expert" : "ccbuddy-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "ccbuddy-expert" : "ccbuddy-workflow",
