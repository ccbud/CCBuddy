import type { EmbeddedSearchBackend } from "@ccbuddy/contracts";
import { getRuntimeToolRuntime } from "@ccbuddy/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "CCBUDDY_EMBEDDED_SEARCH_COMMAND";
