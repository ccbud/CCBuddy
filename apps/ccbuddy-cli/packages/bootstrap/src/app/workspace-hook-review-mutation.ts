...
import { digestSummary, workspaceIdentitySummary } from "@ccbuddy/core";
import {
...
export function createWorkspaceHookReviewMutationPort(
  ...
  const editableConfigPath = resolve(
...
async function rebuildSnapshot(
  ...
  const discovery = await readWorkspaceHookProjectSources({
    ...
    ownedWorkspaceConfigPath: resolve(
      resolveWorkspaceStateRoot(options.workingDirectory, {
