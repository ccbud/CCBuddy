import { ModelErrorCode, ModelProtocolError } from "@ccbuddy/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): CCbuddyModelOption {
