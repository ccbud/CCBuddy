import { ccbuddyWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@ccbuddy/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(ccbuddyWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
