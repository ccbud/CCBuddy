import { ccbuddyWorkspaceUpdateInteractionPreferencesParamsSchema } from "@ccbuddy/shared";
...
export async function updateInteractionPreferences(
  ...
  const params = parseParams(ccbuddyWorkspaceUpdateInteractionPreferencesParamsSchema, rawParams);
