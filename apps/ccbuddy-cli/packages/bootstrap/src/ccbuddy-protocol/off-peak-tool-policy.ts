import { ccbuddyWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@ccbuddy/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(ccbuddyWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
