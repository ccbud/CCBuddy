import { parseRemoteWorkspaceIdentity, type CCbuddyWorkspaceRef } from "@ccbuddy/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): CCbuddyWorkspaceRef {
