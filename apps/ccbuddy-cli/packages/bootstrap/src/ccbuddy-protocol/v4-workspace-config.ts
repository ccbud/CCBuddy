...
import { getCCbuddyAgentModeSelectOptions, normalizeAvailableCCbuddyMode } from "@ccbuddy/shared";
import type { CCbuddySessionSettingsState, CCbuddySlashCommand } from "@ccbuddy/shared";
import type { WorkspaceConfigState } from "@ccbuddy/shared/ccbuddy-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpCCbuddyAgent 的注释）。
