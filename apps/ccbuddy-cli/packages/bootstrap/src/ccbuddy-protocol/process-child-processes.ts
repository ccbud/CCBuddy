import type { McpTrackedProcess } from "@ccbuddy/adapters";
import type { CCbuddyProcessChildProcessesResult } from "@ccbuddy/shared";
...
): CCbuddyProcessChildProcessesResult {
  return {
