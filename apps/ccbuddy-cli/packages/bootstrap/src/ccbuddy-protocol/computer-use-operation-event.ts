...
import type { CCbuddyComputerUseOperationEvent } from "@ccbuddy/shared";
 ...
 * 而非文档软要求：CCbuddy 的 node_repl 每个 cell 都是全新 Worker、SDK 绑定不跨 cell，所以
...
export function mapComputerUseOperationEvent(
  event: SessionEvent,
): CCbuddyComputerUseOperationEvent | undefined {
