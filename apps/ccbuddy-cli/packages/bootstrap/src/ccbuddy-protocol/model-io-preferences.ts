import { ccbuddyWorkspaceUpdateModelIoPreferencesParamsSchema } from "@ccbuddy/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(ccbuddyWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
