import {
  ccbuddyProviderUpdateAccountConfigParamsSchema,
  type CCbuddyProviderUpdateAccountConfigResult,
} from "@ccbuddy/shared";
...
export async function updateAccountProviderConfig(
  ...
  params: unknown,
): Promise<CCbuddyProviderUpdateAccountConfigResult> {
  const envelope = parseParams(ccbuddyProviderUpdateAccountConfigParamsSchema, params);
