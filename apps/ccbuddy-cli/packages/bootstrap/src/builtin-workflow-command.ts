import { expandCustomCommandPrompt, type CustomCommandContent } from "@ccbuddy/contracts";
import { BUILTIN_CCBUDDY_SLASH_COMMAND_HELP_ENTRIES } from "@ccbuddy/shared";
...
const helpEntry = BUILTIN_CCBUDDY_SLASH_COMMAND_HELP_ENTRIES.find(
