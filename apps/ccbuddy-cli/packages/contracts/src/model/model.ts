...
import type { ModelPropertiesData, ModelOptionSpecsData } from "@ccbuddy/shared/model-config";

export type { ModelSelection } from "@ccbuddy/shared/model-selection";
...
} from "@ccbuddy/shared/model-config";
