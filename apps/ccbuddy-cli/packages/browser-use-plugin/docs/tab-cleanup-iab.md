...
- IAB tabs persist for the lifetime of the current CCbuddy process. Turn end, session end, an omitted finalize call,
...
- CCbuddy does not restore these tabs after the CCbuddy process exits.
