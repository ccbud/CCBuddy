...
// @ccbuddy/core 从 tool/handlers/write.js -> memory/origin-session.js eager import 了 CJS 的
...
export const buildBrowserUsePluginBundles = async ({
  ...
  // node_repl 宿主的产物由 @ccbuddy/node-repl-host 自己构建与携带；这个包只出 browser-client。
