...
import { SessionEventType, type SessionEvent } from "@ccbuddy/contracts";
import type {
...
export type SubagentItem = CCbuddySessionRunningSubagent | CCbuddySessionEndedSubagent;
const EMPTY_DIRECTORY: CCbuddySessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
