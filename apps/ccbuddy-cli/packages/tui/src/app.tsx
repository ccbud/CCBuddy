import type { ModelUsageSummary, TodoItem, TurnId } from "@ccbuddy/contracts";
import { getCCbuddyCopy } from "@ccbuddy/i18n";
...
export function TuiApp({
  ...
  const initialCopy = getCCbuddyCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getCCbuddyCopy(locale), [locale]);
