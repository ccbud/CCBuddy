 ...
 */
const INTERACTIVE_REQUIRED_BRAND = Symbol.for("ccbuddy.mcp.oauth.interactiveAuthorizationRequired");
const TEMPORARY_REFRESH_FAILURE_BRAND = Symbol.for("ccbuddy.mcp.oauth.temporaryRefreshFailure");
