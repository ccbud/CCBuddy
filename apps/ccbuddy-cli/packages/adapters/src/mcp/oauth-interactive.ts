...
import type { Logger, McpOAuthConfig } from "@ccbuddy/contracts";
import {
...
class InteractiveAuthorizationProvider implements OAuthClientProvider {
  ...
  private readonly credentialStore: SharedCCbuddyCredentialStore;
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      client_name: this.config.clientName ?? `CCbuddy ${this.serverName}`,
