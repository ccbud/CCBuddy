...
import { ModelApiActorKind, ModelApiOperation, ModelRequestSessionType } from "@ccbuddy/contracts";
import { isOpenCodeGoBaseUrl } from "./opencode-session.js";
import type { ModelStatusContext } from "./runner-status.js";

const MODEL_TRACE_HEADER = "x-ccbuddy-trace-id";
...
const MODEL_SESSION_TYPE_HEADER = "x-ccbuddy-session-type";
