...
import type { NodeReplCuaAppIdentity, NodeReplRequestMeta, NodeReplSession } from "@ccbuddy/core";
import { CUA_APP_ASSOCIATIONS_META_KEY } from "@ccbuddy/ccbuddy-cua/host-display-contract";
import type { CallToolResult } from "@modelcontextprotocol/sdk/types.js";

export const NODE_REPL_CUA_BRIDGE_SYMBOL = Symbol.for("ccbuddy.node-repl.computer-use-bridge");
