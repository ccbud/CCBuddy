...
import type { BrowserClientTransport } from "@ccbuddy/core/browser-client";
import type { NodeReplRequestMeta, NodeReplSession } from "@ccbuddy/core/repl";
import type { BrowserCommand, BrowserCommandResult } from "@ccbuddy/shared";
...
} from "@ccbuddy/shared/node-repl-browser-broker";
import {
