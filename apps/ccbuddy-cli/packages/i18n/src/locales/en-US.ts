...
export const enUS: CCbuddyCopy = {
  ...
  cli: {
    ...
    help: (version) => `ccbuddy ${version}

Usage:
  ccbuddy [command] [options]

With no command, ccbuddy opens the full-screen TUI.

Commands:
  app-server Run the CCbuddy stdio app server
...
`,
  ...
  tui: {
    ...
    loginRequired: {
      help: "Configure your own model provider, then use /model to choose a model.",
      message: "No available models. Configure your own model provider.",
      status: "No available models. Configure your own model provider.",
    ...
    terminal: {
      ...
      starting: "Starting CCbuddy... Ctrl+C to exit",
    },
    transcript: {
      compact: {
