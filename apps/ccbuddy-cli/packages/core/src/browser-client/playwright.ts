...
} from "@ccbuddy/contracts/browser-control";
...
const locatorDetails = Symbol("ccbuddy.playwright.locatorDetails");
const setObjectWrapper = Symbol("ccbuddy.playwright.setObjectWrapper");
