...
import type { EnvInfo } from "@ccbuddy/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are CCbuddy Explore, a file search and codebase research specialist for CCbuddy CLI. You excel at thoroughly navigating and exploring codebases.",
    "",
