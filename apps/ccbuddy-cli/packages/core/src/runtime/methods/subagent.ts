...
import { RESPOND_TO_COORDINATOR_TOOL_NAME } from "@ccbuddy/contracts";
import type { SubagentRunOptions } from "@ccbuddy/contracts";
import {
  defaultScheduler,
  PermissionService,
    ...
    runExploreAgent: async (request, options) => {
      ...
      const childRuntime = new AgentRuntime(
        request.sessionId,
        {
          ...
          agentName: `ccbuddy-${request.agentType}`,
