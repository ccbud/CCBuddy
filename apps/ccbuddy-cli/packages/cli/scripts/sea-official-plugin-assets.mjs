...
export const seaOfficialPluginAssetPrefix = "ccbuddy-official-plugins/";
...
export const officialSeaPlugins = [
  {
    ...
    marketplace: "ccbuddy-plugins-official",
    name: "node-repl-host",
...
function assertPluginRoot(pluginRoot, plugin) {
  if (!existsSync(join(pluginRoot, ".ccbuddy-plugin", "plugin.json"))) {
