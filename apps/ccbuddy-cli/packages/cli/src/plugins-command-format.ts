import { formatJson } from "@ccbuddy/core";
import type { GlobalOptions, JsonValue, RunContext } from "@ccbuddy/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly CCbuddyAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly CCbuddyMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetCCbuddyPluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetCCbuddyPluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: CCbuddyAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: CCbuddyInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: CCbuddyMarketplaceSummaryData) {
  return {
    id: marketplace.id,
