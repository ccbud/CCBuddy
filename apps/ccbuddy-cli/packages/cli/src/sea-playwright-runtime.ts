...
import type { PlaywrightChromiumModule } from "@ccbuddy/adapters/browser";
import { resolveSeaRuntimeCacheBaseDirectory } from "./sea-runtime-cache-path.js";
...
const ASSET_PREFIX = "ccbuddy-playwright-runtime/";
...
export async function loadCliPlaywrightChromium(): Promise<PlaywrightChromiumModule> {
  ...
  const require = createRequire(join(runtimeDirectory, "ccbuddy-playwright-loader.cjs"));
