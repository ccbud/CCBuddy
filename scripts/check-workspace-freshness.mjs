...
//
// 背景：本地 ccbuddy-cua 曾落后 origin/main 140 个提交（本地 Skill 仍
// 558 行、主线已收敛到 128 行），ccbuddy 集成分支曾落后自己的远端 29 个提交，都曾在
// 旧基线上开工。任何会话开始前先跑本脚本（ccbuddy-cua 仓库用它的 python 等价物）。
//
// 判定规则：
